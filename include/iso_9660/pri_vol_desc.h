...
typedef struct _PriVolDesc_s
{
  ...
  */
  ...
  _PVDDateTime_t volume_creation_date_time;
  _PVDDateTime_t volume_modification_date_time;
  _PVDDateTime_t volume_expiration_date_time;
  _PVDDateTime_t volume_effective_date_time;
