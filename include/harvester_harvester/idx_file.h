 ...
 *  observations from studying these files and their associated .dat's in a hex
 *  editor. It's worth noting that there is some additional data (between the
 *  `path` and `extent_loc` data fields) included in these files that we're
 ...
 *  open an issue/pull request modifying this project as needed!
 *  Please see `harvester_harvester/idx_file.c` file for more details.
 *
